...
const { raiseComplaint, viewComplaints, viewAmenities, bookAmenities, viewBookings, viewNotices, viewNoticeForLoggedInResident, maintenancePayment, viewMaintenancePayments, getActiveMaintenanceSetting, viewVisitors } = require('../controllers/resident.controller');
...
router
    ...
    .get('/view-visitors', viewVisitors)
